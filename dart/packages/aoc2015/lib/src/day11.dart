...
class Day11 extends AdventDay {
  ...
  static final nextChar = Map<String, String>.fromEntries(alphabet
      .mapIndexed((i, ch) => MapEntry(ch, alphabet[(i + 1) % alphabet.length])))
    ..['h'] = 'j' // Skip the special chars i, o, and l.
    ..['n'] = 'p'
    ..['k'] = 'm';

  static final RegExp _straightPattern = RegExp(List<String>.generate(
          alphabet.length - 2, (int i) => alphabet.getRange(i, i + 3).join())
      .join('|'));
